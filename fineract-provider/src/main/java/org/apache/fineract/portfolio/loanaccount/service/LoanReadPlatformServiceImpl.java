...
public class LoanReadPlatformServiceImpl implements LoanReadPlatformService, LoanReadPlatformServiceCommon {
    ...
    public LoanTransactionData retrieveLoanPrePaymentTemplate(final LoanTransactionType repaymentTransactionType, final Long loanId,
        ...
        return new LoanTransactionData(null, null, null,
                transactionType, null, currencyData, earliestUnpaidInstallmentDate,
                ...
                paymentOptions, ExternalId.empty(), null,
                null, outstandingLoanBalance, false,
                loanId, loan.getExternalId(), rebatePolicies);
    }

    // Method to calculate rebate amount based on loan's disbursement date and current date
    private BigDecimal calculateRebate(LocalDate disbursementDate, LocalDate currentDate, Collection<RebateData> rebatePolicies, BigDecimal loanAmount) {
        BigDecimal rebateAmount = BigDecimal.ZERO;

        for (RebateData rebatePolicy : rebatePolicies) {
            if (isWithinRebatePeriod(disbursementDate, currentDate, rebatePolicy)) {
                BigDecimal percentage = rebatePolicy.getRebatePercentage().divide(BigDecimal.valueOf(100));
                rebateAmount = loanAmount.multiply(percentage);
                break; // Assuming we apply only one applicable rebate policy
            }
        }
        return rebateAmount;
    }

    // Helper method to check if the given date falls within the rebate period
    private boolean isWithinRebatePeriod(LocalDate disbursementDate, LocalDate currentDate, RebateData rebatePolicy) {
        return disbursementDate.plusDays(rebatePolicy.getDaysFrom()).isBefore(currentDate)
                && disbursementDate.plusDays(rebatePolicy.getDaysTo()).isAfter(currentDate);
    }
    ...
    public LoanTransactionData retrieveRecoveryPaymentTemplate(Long loanId) {
        ...
        return new LoanTransactionData(null, null, null, transactionType, null, null, null, loan.getTotalWrittenOff(),
                ...
                null, null, outstandingLoanBalance, false, loanId, loan.getExternalId(), null);
    ...
    public LoanTransactionData retrieveLoanWriteoffTemplate(final Long loanId) {
        ...
        LoanTransactionData loanTransactionData = new LoanTransactionData(null, null, null, transactionType, null, loan.getCurrency(),
                ...
                ExternalId.empty(), null, null, null, null, false, loanId, loan.getExternalId(),null);
    ...
    public LoanTransactionData retrieveLoanChargeOffTemplate(final Long loanId) {
        ...
        LoanTransactionData loanTransactionData = new LoanTransactionData(null, null, null, transactionType, null, loan.getCurrency(),
                ...
                false, loanId, loan.getExternalId(),null);
    ...
    public LoanTransactionData retrieveLoanForeclosureTemplate(final Long loanId, final LocalDate transactionDate) {
        ...
        return new LoanTransactionData(null, null, null, transactionType, null, currencyData, earliestUnpaidInstallmentDate,
                ...
                paymentTypeOptions, ExternalId.empty(), null, null, outstandingLoanBalance, isReversed, loanId, loan.getExternalId(), null);
    }
    ...
    private static final class RepaymentTransactionTemplateMapper implements RowMapper<LoanTransactionData> {
        ...
        public LoanTransactionData mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            return new LoanTransactionData(id, officeId, officeName, transactionType, paymentDetailData, currencyData, date, totalDue,
                    ...
                    fixedEmiAmount, outstandingLoanBalance, unrecognizedIncomePortion, manuallyReversed, loanId, ExternalId.empty(), null);
        }
