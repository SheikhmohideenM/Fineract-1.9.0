...
public class LoanProductConfiguration {
    ...
    public LoanProductReadPlatformService loanProductReadPlatformService(PlatformSecurityContext context, JdbcTemplate jdbcTemplate,
                                                                         ChargeReadPlatformService chargeReadPlatformService, RateReadService rateReadService,
                                                                         RebateReadPlatformService loanProductRebateReadPlatformService,
        ...
        return new LoanProductReadPlatformServiceImpl(context, jdbcTemplate, chargeReadPlatformService, rateReadService,loanProductRebateReadPlatformService, sqlGenerator,
    ...
    public LoanProductWritePlatformService loanProductWritePlatformService(PlatformSecurityContext context,
                                                                           ...
                                                                           FundRepository fundRepository, ChargeRepositoryWrapper chargeRepository, RateRepositoryWrapper rateRepository, RebateRepositoryWrapper rebateRepository,
        ...
        return new LoanProductWritePlatformServiceJpaRepositoryImpl(context, fromApiJsonDeserializer, loanProductRepository, aprCalculator,
                fundRepository, chargeRepository, rateRepository, rebateRepository, accountMappingWritePlatformService, fineractEntityAccessUtil,
